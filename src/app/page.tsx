    ...
    <div className="min-h-screen flex items-center justify-center relative">
      ...
      <main className="relative z-10 w-full max-w-md mx-auto p-6">
          ...
          {!userType ? (
            <div className="space-y-4">
              ...
              <div className="mt-6 text-center text-xs text-gray-600">
                <p>
                  &copy; 2024 <a href="https://robindoylerealestate.com/properties/" target="_blank" rel="noopener noreferrer" className="hover:underline">Robin Doyle</a>. All rights reserved.
                </p>
                <p className="mt-1">
                  <a href="https://expworldholdings.com/privacy-policy/" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:underline">Privacy Policy</a>
                </p>
              </div>
            </div>
                ...
                <div className="mt-3">
                  <label className="flex items-center">
                    ...
                    <span className="ml-2 text-xs text-gray-700">
                      ...
                      <a href="https://expworldholdings.com/privacy-policy/" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:underline">
                        Privacy Policy
                      </a>
                      .
                    </span>
            ...
            <div className="text-center">
              ...
              <a
                href="https://api.leadconnectorhq.com/widget/booking/0EiWjoOD6kw5drmfyxmb"
                target="_blank"
        ...
        <footer className="mt-6 text-center text-xs text-gray-700 drop-shadow">
          ...
          <p className="mt-1">
            <a href="https://expworldholdings.com/privacy-policy/" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:underline">Privacy Policy</a>
          </p>
        </footer>
      </main>
    </div>
